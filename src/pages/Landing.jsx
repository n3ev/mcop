...
export default function Landing() {
  ...
  return (
    <div className="cross-section">
        ...
        <div className="wrap frame how-section">
          ...
          <div className="hour-grid">
            <div className="hour-card">
              ...
              <p className="hour-desc">"Right now" matches fastest. Willing to wait? We hold your spot and email you the moment your buddy appears.</p>
            </div>
            <div className="hour-card">
              <span className="hour-icon" aria-hidden="true">⚖️</span>
              <h3 className="hour-title">Weighted answers</h3>
              <p className="hour-desc">Core questions weigh double. A builder who loves chatting won't get a silent speedrunner.</p>
            </div>
            <div className="hour-card">
              <span className="hour-icon" aria-hidden="true">🔐</span>
              <h3 className="hour-title">Whitelist, not luck</h3>
              <p className="hour-desc">The server only admits the two exact usernames in your match. Nobody else can even connect.</p>
            </div>
            <div className="hour-card">
              <span className="hour-icon" aria-hidden="true">🌱</span>
      ...
      {/* ── quests that fit in an hour ── */}
      <section className="stratum-stone">
        <div className="wrap frame how-section" style={{ maxWidth: 860 }}>
          <p className="section-eyebrow">Quests from the board</p>
          <p className="muted" style={{ maxWidth: 600, margin: '0 auto 20px' }}>
      ...
      {/* ── live status + house rules ── */}
      <section className="stratum-deep">
        <WorldStatus />
      </section>
      <section className="stratum-deep">
        <div className="wrap frame how-section" style={{ maxWidth: 760 }}>
        ...
        <div className="wrap frame how-section">
          ...
          <div className="hour-grid">
            <div className="hour-card">
              ...
              <p className="hour-desc">Reconnect with a past buddy straight from your friends list.</p>
            </div>
            <div className="hour-card">
              <span className="mc-badge">digging now</span>
              <h3 className="hour-title" style={{ marginTop: 10 }}>Report tools</h3>
              <p className="hour-desc">Full report-with-reason flow to back up the house rules.</p>
            </div>
            <div className="hour-card">
            ...
            <div className="hour-card">
              <span className="mc-badge">surveyed</span>
              <h3 className="hour-title" style={{ marginTop: 10 }}>Steam linking</h3>
              <p className="hour-desc">Surface shared games and hours for instant common ground.</p>
            </div>
          </div>
        </div>
      </section>

      {/* ── fresh from the crafting table ── */}
      <section className="stratum-mineshaft">
        <div className="wrap frame how-section" style={{ maxWidth: 760 }}>
